...
// <DDSETTINGS>
// Please don't edit anything between <DDSETTINGS> tag.
// This section is autogenerated by Acquia Dev Desktop.
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_stckyfngers_dd.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_stckyfngers_dd.inc';
}

if (empty($config_directories['active']))
    $config_directories['active'] = "sites/default/files/config_acqTmp-2022-02-03T10.20.35-8938/active";
    $settings["config_sync_directory"] = $config_directories['active'];
if (empty($config_directories['staging']))
    $config_directories['staging'] = "sites/default/files/config_acqTmp-2022-02-03T10.20.35-8938/staging";
    $settings["config_sync_directory"] = $config_directories['staging'];

if (empty($settings['hash_salt']))
      $settings['hash_salt'] = 'ZGVmYXVsdAAtGJtmwCA=';
// </DDSETTINGS>
